...
#SBATCH --output=logs/STAR_v1_log.out
...
# Directories
input_dir="$root_dir/01_fastqs/merged"
output_dir="$root_dir/04_STAR"
genome_indices="$root_dir/00_reference_genomes/human/indices"
start_time=$(date +%s)
